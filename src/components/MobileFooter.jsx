...
const MobileFooter = () => {
  ...
  return (
    <div className='w-full bg-black pt-28 text-white'>
      <div className="w-[90%] mx-auto flex gap-x-2 justify-between items-center">
        {/* section-1  */}
        <div className="w-[48%]">
          {/* logo  */}
          <div className="w-fit">
        ...
        <div className="w-[48%] flex flex-col gap-y-4">
          <h3 className='uppercase text-[#ccc] text-[18px] font-[600] tracking-wider'>opening hours</h3>
          <p className='text-[14px] font-[600]'>Working days / 08:00 - 20:00</p>
          <p className='text-[14px] font-[600]'>Saturday / 08:00 - 20:00</p>
          <p className='text-[14px] font-[600]'>Sunday / CLOSED</p>
        </div>
        {/* Section-3  */}
      </div>
